import fotoKari from "./images/foto-Karina.png";
import "./style.css"
import producticon from "./images/productos-frescos.png";
import hornoicon from "./images/horneamos-con-amor.png";
import timeicon from "./images/entrega-a-tiempo.png";
  ...
  return (
    <div className="container-fluid" >
      <div className="first row container-fluid" >
        <div className="img-container col-sm-12  col-md-4 col-lg-6 "> <img  src={fotoKari} alt="" /> </div>
