...
export declare function FloatingWhatsApp({ onClick, onSubmit, onClose, onLoopDone, phoneNumber, accountName, chatboxHeight, avatar, statusMessage, chatMessage, placeholder, darkMode, allowClickAway, allowEsc, notification, notificationDelay, notificationLoop, notificationSound, notificationSoundSrc, style, buttonStyle, chatboxStyle, className, buttonClassName, chatboxClassName }: FloatingWhatsAppProps): JSX.Element;
